...
*** If you are able to test, Robust_Chat v1.3.9.f, REQUIRES FOLLOWING VT323-regular.ttf and Store_with_messages.ZIP extracted in same folder ,its appreciated, Thank you M0OLI

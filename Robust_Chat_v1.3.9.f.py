...
"""
LiNK500 Teensy Chat v1.3.9.f Consolidated (Explicit Fleet Mode) (2025-09-12)
...
class ChatApp(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Robust Chat v1.3.9.f")
...
def main():
    print("Link500 Teensy Robust Chat v1.3.9.f (2025-09-14)")
